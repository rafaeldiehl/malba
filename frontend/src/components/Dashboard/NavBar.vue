...
export default {
  ...
  methods: {
    handleMobileView() {
      this.mobileView = window.innerWidth <= 635;
    }
  },
  created() {
...
.dashboard-navbar {
  @apply h-[5.25rem] bg-white flex justify-center items-center border-b-zinc-200 border-b-2;
...
.profile {
  @apply flex flex-row gap-5 px-4;
  ...
  .profile-data {
    ...
    a {
      @apply text-sky-600 underline underline-offset-2 text-sm;
    }
  }
